...
const FLASH = {
    ...
    "env-saved": { tone: "ok", text: "Environment saved. It is written to the checkout's .env on the next deploy." },
    created: { tone: "ok", text: "Project registered." },
    cloning: { tone: "ok", text: "Cloning the repository and starting the stack — the log is below." },
    exists: { tone: "info", text: "That project is already registered." },
